...
buoy_info.serial = 'SPOT-30851C'; %spotter serial number, or just Datawell 
...
buoy_info.DeployLoc = 'YanchepLagoon';
buoy_info.DeployDepth = 10; 
buoy_info.DeployLat = -31.554450; 
buoy_info.DeployLon = 115.621733; 
