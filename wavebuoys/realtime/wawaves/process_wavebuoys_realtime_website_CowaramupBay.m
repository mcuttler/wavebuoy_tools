...
buoy_info.serial = 'SPOT-1832'; %spotter serial number, or just Datawell 
buoy_info.name = 'CowaramupBay'; 
buoy_info.datawell_name = 'nan'; 
buoy_info.version = 'V2'; %or DWR4 for Datawell, for example
buoy_info.sofar_token = 'f8f4c8b08d51c3440bfd7042bf40d1'; 
buoy_info.utc_offset = 8; 
buoy_info.DeployLoc = 'CowaramupBay';
buoy_info.DeployDepth = 5; 
buoy_info.DeployLat = -33.8610;  
buoy_info.DeployLon = 114.9877; 
...
if strcmp(buoy_info.type,'sofar')==1            
    ...
    if flag == 1
        ...
        if all(check)~=0        
            ...
            realtime_archive_text(buoy_info, SpotData, 2); 
