...
buoy_info.serial = 'SPOT-31479C'; %spotter serial number, or just Datawell 
buoy_info.name = 'TIDE_SouthAfricaDrifting08'; 
buoy_info.datawell_name = 'nan'; 
buoy_info.version = 'V3'; %V1, V2, smart_mooring, Datawell, Triaxys
buoy_info.sofar_token = 'e0eb70b6d9e0b5e00450929139ea34'; 
buoy_info.utc_offset = 8; 
buoy_info.DeployLoc = 'SouthAfrica_Drifting';
