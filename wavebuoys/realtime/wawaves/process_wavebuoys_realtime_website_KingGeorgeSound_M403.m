...
buoy_info.serial = 'SPOT-1669'; %spotter serial number, or just Datawell 
buoy_info.name = 'KingGeorgeSound_M403'; 
buoy_info.datawell_name = 'nan'; 
buoy_info.version = 'V2'; %or DWR4 for Datawell, for example
buoy_info.sofar_token = 'e0eb70b6d9e0b5e00450929139ea34'; 
buoy_info.utc_offset = 8; 
buoy_info.DeployLoc = 'KingGeorgeSound_M403_1669';
buoy_info.DeployDepth = 15; 
buoy_info.DeployLat = -35.079650; 
buoy_info.DeployLon = 117.977283; 
