...
dpath = 'Y:\CUTTLER_wawaves\Data\website\wawaves'; 
dname = 'buoys_metadata_new_deploy.csv'; 

buoy_metadata = readtable(fullfile(dpath,dname),'VariableNamingRule','preserve'); 

%create log file for this run
log_path = 'G:\wawaves\log_files'; %modify this in future
...
for jj = 1:size(buoy_metadata)
    ...
    try
        [log_message] = batch_realtime_service(buoy_info);
