...
buoy_info.serial = 'SPOT-0552'; %spotter serial number, or just Datawell 
buoy_info.name = 'CapeBridgewater'; 
buoy_info.datawell_name = 'nan'; 
buoy_info.version = 'V2'; %or DWR4 for Datawell, for example
buoy_info.sofar_token = 'ae7abf179e2b697c24fea513aae16e'; 
buoy_info.utc_offset = 10; 
buoy_info.DeployLoc = 'CapeBridgewater';
buoy_info.DeployDepth = 69; 
buoy_info.DeployLat = -38.358156;
buoy_info.DeployLon = 141.270484;
buoy_info.UpdateTime =  1; %hours
buoy_info.DataType = 'parameters'; %can be parameters if only bulk parameters, or spectral for including spectral coefficients
buoy_info.archive_path = 'E:\vicwaves';
buoy_info.website_filename = 'vicbuoys.csv'; %filename that contains info for wawaves/vicowaves - code
buoy_info.backup_path = '\\drive.irds.uwa.edu.au\OGS-COD-001\CUTTLER_wawaves\Data\vicwaves_realtime_backup'; 
buoy_info.datawell_datapath = 'E:\waved'; %top level directory for Datawell CSVs
%data for search radius and alert
buoy_info.time_cutoff = 3; %hours
buoy_info.search_rad = 500; %meters for watch circle radius 
