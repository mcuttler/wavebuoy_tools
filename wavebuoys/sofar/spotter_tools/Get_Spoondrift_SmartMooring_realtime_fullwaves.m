...
%%
function [Spotter,flag] = Get_Spoondrift_SmartMooring_realtime_fullwaves(buoy_info, limit);
...
%Spectral variables
if isfield(resp_waves.Body.Data.data,'frequencyData')
    for j = 1:size(resp_waves.Body.Data.data.frequencyData)
        Spotter.spec_time = datenum(resp_waves.Body.Data.data.frequencyData(j).timestamp,'yyyy-mm-ddTHH:MM:SS'); 
        Spotter.a1 = resp_waves.Body.Data.data.frequencyData.a1';
        Spotter.a2 = resp_waves.Body.Data.data.frequencyData.a2';
        Spotter.b1 = resp_waves.Body.Data.data.frequencyData.b1';
        Spotter.b2 = resp_waves.Body.Data.data.frequencyData.b2';
        Spotter.varianceDensity = resp_waves.Body.Data.data.frequencyData.varianceDensity';
        Spotter.frequency = resp_waves.Body.Data.data.frequencyData.frequency';
        Spotter.df = resp_waves.Body.Data.data.frequencyData.df';
        Spotter.directionalSpread = resp_waves.Body.Data.data.frequencyData.directionalSpread';
        Spotter.direction = resp_waves.Body.Data.data.frequencyData.direction';
    end
end
