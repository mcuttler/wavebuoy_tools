...
h(2) = plot(data.time(data.WAVE_quality_control==3), data.hs(data.WAVE_quality_control==3),'co'); 
end
if any(data.WAVE_quality_control==4)
h(3) = plot(data.time(data.WAVE_quality_control==4), data.hs(data.WAVE_quality_control==4),'ro'); 
end
datetick('x','dd-mmm'); 
text(0.05, 0.95,'(a)','units','normalized'); 
ylabel('Hs (m)'); 
...
if any(data.WAVE_quality_control==3) & any(data.WAVE_quality_control==4)
...
plot(data.time, data.tp); 
hold on; grid on; 
plot(data.time(data.WAVE_quality_control==3), data.tp(data.WAVE_quality_control==3),'co'); 
plot(data.time(data.WAVE_quality_control==4), data.tp(data.WAVE_quality_control==4),'ro'); 
datetick('x','dd-mmm');
xlabel('Date'); 
ylabel('Tp (s)'); 
...
plot(data.time, data.dp); 
hold on; grid on; 
plot(data.time(data.WAVE_quality_control==3), data.dp(data.WAVE_quality_control==3),'co'); 
plot(data.time(data.WAVE_quality_control==4), data.dp(data.WAVE_quality_control==4),'ro'); 
datetick('x','dd-mmm');
xlabel('Date'); 
ylabel('Dp (deg from)'); 
...
scatter((1:length(data.time)),data.TEMP_quality_control)
...
flag_per.bad = length(find(data.WAVE_quality_control==4))/length(data.WAVE_quality_control);
flag_per.suspect = length(find(data.WAVE_quality_control==3))/length(data.WAVE_quality_control);
...
fid = figure; 
ax(1) = subplot(2,1,1); 
h(1) = scatter(data.time, data.WAVE_quality_control);
hold on; grid on;
datetick('x','dd-mmm'); 
text(0.05, 0.95,'(a)','units','normalized'); 
...
h(1) = plot(data.hs);
hold on; grid on;
h(2) = scatter(find(data.WAVE_quality_control==3),data.hs(data.WAVE_quality_control==3),'co'); 
h(3) = scatter(find(data.WAVE_quality_control==4),data.hs(data.WAVE_quality_control==4),'ro'); 
text(0.05, 0.95,'(a)','units','normalized'); 
ylabel('Hs (m)'); 
l = legend(h,{'Data','Suspect','Fail'}); 
%     'Flagged Data (' num2str(round(length(find(data.quality_flag>1))./length(data.quality_flag)*100,2)) '%)']}); 
...
plot(data.tp); 
hold on; grid on; 
scatter(find(data.WAVE_quality_control==3),data.tp(data.WAVE_quality_control==3),'co'); 
scatter(find(data.WAVE_quality_control==4),data.tp(data.WAVE_quality_control==4),'ro'); 
ylabel('Tp (s)'); 
...
plot(data.dp); 
hold on; grid on; 
scatter(find(data.WAVE_quality_control==3),data.dp(data.WAVE_quality_control==3),'co'); 
scatter(find(data.WAVE_quality_control==4),data.dp(data.WAVE_quality_control==4),'ro'); 
ylabel('Dp (deg from)'); 
...
fid = figure; 
ax(1) = subplot(2,1,1); 
h(1) = scatter((1:length(data.time)), data.WAVE_quality_control);
hold on; grid on;
text(0.05, 0.95,'(a)','units','normalized'); 
ylabel('Quality Flag'); 
